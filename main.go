...
var (
	accessToken = "eyJzdWIiOiIzNDJlOTZlNS1kNWQwLTQ4MWMtYTc3Ny0wYzFkM2RhZGIyZTkiLCJ2ZXIiOiI5ZTgzNzQzMC1iNzZmLTQ0NDMtYmYxZS1jMzk1NjRjYTRkYjQiLCJleHAiOjB9" // API access token string
)
